...
const mensajesAmor = [
    "VIC PERSI", "TE QUIERO", "VIC PERSI", "VIC PERSI", "ERES ÚNICA",  
    "VIC PERSI", "MI VIDA", "MI CORAZÓN", "MI ALMA", "MI LUZ",  
    "MI RAZÓN", "VIC PERSI", "MI SUEÑO", "MI DESEO", "MI PASIÓN",  
    "MI TESORO", "VIC PERSI", "MI SOL", "MI ESTRELLA", "MI DESTINO",  
    "MI SUERTE", "VIC PERSI", "MI AMIGA", "MI APOYO", "MI REFUGIO",  
    "MI PAZ", "VIC PERSI", "MI FUERZA", "VIC PERSI", "MI SONRISA",  
    "MI RISITA", "VIC PERSI", "MI SERENIDAD", "MI EQUILIBRIO",  
    "VIC PERSI", "MI NARANJA", "MI GEMELA", "MI TODO",  
    "MI ETERNA", "MI INFINITO", "MI PRESENTE", "MI FUTURO", "MI PASADO",  
    "MI HOY", "VIC PERSI", "MI SIEMPRE", "MI NUNCA", "MI AHORA"
...
function crearExplosionTexto(e) {
    ...
    const textosAmor = ["VIC PERSI", "ERES MÍA", "VIC PERSI", "VIC PERSI", "MI VIDA", "VIC PERSI", "MI CORAZÓN", "VIC PERSI"];
